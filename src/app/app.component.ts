...
export class AppComponent implements OnChanges, OnDestroy {
  ...
  showAlert() {
    this.msg.emit({ action: 'setAlert', payload: { title: 'Homepage Alert', message: 'This alert was generated by the homepage MFE' } });
  }
  ...
  showPanel() {
    this.msg.emit({
      ...
      payload: {
        ...
        message: 'This panel was generated by the homepage MFE',
