...
var compileComponent = (components) => {
  var buildJsFiles = `ng build --extra-webpack-config webpack.externals.js --outputPath='${__dirname}/dist/tmp' --single-bundle${prodExt} --main='src/components/${components[componentIncrement]}/compile.ts'`;
  var copyBundledComponent = `cp ${__dirname}/dist/tmp/main.js ${__dirname}/dist/components/shared-${components[componentIncrement]}.js`;

  console.log(buildJsFiles);
  console.log(copyBundledComponent);
